...
public class HibernateWithJPAWithH2Test extends AbstractTestNGSpringContextTests {
    ...
    public static Object[][] students() {
        return new Object[][]{{"John Smith", "1234567890"}, {"Malcolm X", "9876543210"}};
    }
    ...
    public void readAllStudents() {
        ...
        Assert.assertTrue(studentRepository.findAll().size() > 3);
    }
